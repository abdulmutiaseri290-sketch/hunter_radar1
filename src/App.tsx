...
// نظام رادار 1 - النسخة الذهبية المصححة (2026)
      ...
      <div style={{ backgroundColor: '#0a0a0a', color: '#FFD700', height: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', fontFamily: 'sans-serif', textAlign: 'center', padding: '20px' }}>
        ...
        <div style={{ backgroundColor: '#161616', padding: '30px', borderRadius: '25px', border: '1px solid #FFD700', width: '100%', maxWidth: '300px', boxShadow: '0 10px 30px rgba(0,0,0,0.5)' }}>
          <input 
            ...
            placeholder="****"
          />
          <button onClick={handleLogin} style={{ width: '100%', padding: '15px', backgroundColor: '#FFD700', color: '#000', border: 'none', borderRadius: '12px', fontWeight: 'bold', fontSize: '1.2rem', cursor: 'pointer' }}>دخول للنظام</button>
        </div>
      </div>
    );
  }
        ...
        {activeTab === 'radar' && (
          <div style={{ textAlign: 'center', marginTop: '40px' }}>
            <div style={{ position: 'relative', width: '250px', height: '250px', margin: '0 auto', border: '2px solid #004400', borderRadius: '50%', backgroundColor: '#001a00', overflow: 'hidden' }}>
              ...
              <div style={{ position: 'absolute', top: '40%', left: '60%', width: '10px', height: '10px', backgroundColor: '#FFD700', borderRadius: '50%', boxShadow: '0 0 15px #FFD700' }}></div>
            </div>
            <h3 style={{ color: '#00ff00', marginTop: '25px' }}>متصل بالستلايت - جاري المسح</h3>
            <div style={{ marginTop: '30px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px' }}>
              ...
              <div style={{ backgroundColor: '#111', padding: '15px', borderRadius: '15px', borderLeft: '4px solid #00ff00' }}>
                <small style={{ color: '#888' }}>الحالة</small>
                <div style={{ fontSize: '1.2rem', color: '#00ff00' }}>نشط</div>
              </div>
            </div>
          </div>
        )}
