...
<head>
    ...
    <style>
        ...
        .gold { color: #FFD700; }
        .card { background: #111; padding: 30px; border-radius: 25px; border: 1px solid #FFD700; box-shadow: 0 0 20px rgba(255, 215, 0, 0.1); }
        input { padding: 15px; border-radius: 12px; border: 2px solid #FFD700; background: #222; color: #fff; font-size: 1.5rem; width: 80%; text-align: center; margin-bottom: 20px; }
        ...
        .radar { width: 200px; height: 200px; border: 2px solid #004400; border-radius: 50%; margin: 30px auto; position: relative; background: #001a00; overflow: hidden; }
